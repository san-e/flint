...
warnings.formatwarning = (
    lambda message, *args, **kwargs: f"{message!s}\n"
...
def invalidate_specific_cache(function: Function) -> None:
    central_cache[f"{function.__module__}.{function.__name__}"].cache_clear()


def invalidate_cache():
    """Invalidate (empty) the central cache."""
    for f in central_cache.values():
